...
var file_sso_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x22, 0x57, 0x0a, 0x0d, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x73, 0x0a, 0x03, 0x53, 0x53, 0x4f, 0x12, 0x2e,
...
var file_sso_proto_goTypes = []any{
	...
	(*TokenResponse)(nil),       // 1: sso.TokenResponse
	(*RefreshTokenRequest)(nil), // 2: sso.RefreshTokenRequest
}
var file_sso_proto_depIdxs = []int32{
	0, // 0: sso.SSO.Login:input_type -> sso.LoginRequest
	2, // 1: sso.SSO.RefreshToken:input_type -> sso.RefreshTokenRequest
	1, // 2: sso.SSO.Login:output_type -> sso.TokenResponse
	1, // 3: sso.SSO.RefreshToken:output_type -> sso.TokenResponse
