...
func (_m *SubscriptionRepo) Update(ctx context.Context, userID string, subType domain.SubscriptionType, enabled bool) error {
...
// SubscriptionRepo_Update_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Update'
type SubscriptionRepo_Update_Call struct {
	*mock.Call
}
...
//   - subType domain.SubscriptionType
//   - enabled bool
func (_e *SubscriptionRepo_Expecter) Update(ctx interface{}, userID interface{}, subType interface{}, enabled interface{}) *SubscriptionRepo_Update_Call {
	return &SubscriptionRepo_Update_Call{Call: _e.mock.On("Update", ctx, userID, subType, enabled)}
}

func (_c *SubscriptionRepo_Update_Call) Run(run func(ctx context.Context, userID string, subType domain.SubscriptionType, enabled bool)) *SubscriptionRepo_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *SubscriptionRepo_Update_Call) Return(_a0 error) *SubscriptionRepo_Update_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SubscriptionRepo_Update_Call) RunAndReturn(run func(context.Context, string, domain.SubscriptionType, bool) error) *SubscriptionRepo_Update_Call {
	_c.Call.Return(run)
	return _c
}
